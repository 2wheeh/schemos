...
export const cw721QuerySchema = {
  oneOf: [
    ...
    },
    {
      ...
      type: 'object',
      required: ['get_collection_info_and_extension'],
      properties: {
    ...
    },
    {
      ...
      type: 'object',
      required: ['get_collection_extension_attributes'],
      properties: {
    ...
    {
      description:
        'Return the minter Deprecated: use GetMinterOwnership instead! Will be removed in next release!',
      deprecated: true,
      type: 'object',
      required: ['minter'],
      properties: {
    ...
    {
      type: 'object',
      required: ['get_creator_ownership'],
      properties: {
    ...
    },
    {
      ...
      type: 'object',
      required: ['get_additional_minters'],
      properties: {
    ...
    {
      type: 'object',
      required: ['get_collection_extension'],
      properties: {
