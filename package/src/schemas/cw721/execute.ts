...
export const cw721ExecuteSchema = {
  oneOf: [
    ...
    {
      description:
        "The creator is the only one eligible to update NFT's token uri and onchain metadata (`NftInfo.extension`). NOTE: approvals and owner are not affected by this call, since they belong to the NFT owner.",
      type: 'object',
    ...
    {
      description:
        'Withdraw from the contract to the given address. Anyone can call this, which is okay since withdraw address has been set by owner.',
      type: 'object',
